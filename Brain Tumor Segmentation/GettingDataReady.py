...
print(np.unique(test_mask))  #0, 1, 2, 4 (Need to recode to 0, 1, 2, 3)
test_mask[test_mask==4] = 3  #Reassign mask values 4 to 3
print(np.unique(test_mask)) 

#Randomly plotting a slice of image
import random
...
for img in range(len(t2_list)):   #Using t1_list as all lists are of same size
    ...
    if (1 - (counts[0]/counts.sum())) > 0.01:  #At least 1% useful volume with labels that are not 0, has less than 1% of mask then delete
      print("Save Me")
